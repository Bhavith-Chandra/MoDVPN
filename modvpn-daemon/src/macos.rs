...
const EXCLUSION_GROUP: &[u8] = b"modvpn-exclusion\0";
...
/// Returns the GID of `modvpn-exclusion` group if it exists.
...
/// Attempts to set the GID of the current process to `modvpn
-exclusion`.
