...
use modvpn_entity::device::Entity as Device;
use modvpn_entity::vpn_session::Entity as VpnSession;
use modvpn_migration::sea_orm::{DatabaseConnection, EntityTrait};
    ...
    Ok(TunnelParameters::Wireguard(
        talpid_types::net::wireguard::TunnelParameters {
            connection: ConnectionConfig {
                ...
                ipv6_gateway: None,
                #[cfg(target_os = "linux")]
                fwmark: Some(modvpn_types::TUNNEL_FWMARK),
            },
