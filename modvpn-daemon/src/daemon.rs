...
use modvpn_types::{
    ...
    modvpn_server::{ClientConnected, EndSession, NewSession, UserCredentials, VpnSessionStatus},
...
impl Daemon {
    ...
    async fn set_vpn_status(&mut self, vpn_status: modvpn_types::vpn_session::VpnStatus) {
        // save current state
    ...
    async fn on_connect(
        ...
        location: modvpn_types::location::Location,
    ) {
