...
android {
    namespace = "app.modvpn.modvpn"
    compileSdk = 34

    ndkVersion = "26.1.10909125"

    defaultConfig {
        applicationId = "app.modvpn.modvpn"
        minSdk = 24
        targetSdk = 34
        versionCode = 6
        versionName = "u2"
    ...
    buildTypes {
        ...
        debug {
            ...
            val baseUrl = gradleLocalProperties(rootDir).getProperty("baseUrl", "https://modvpn.dev")
            buildConfigField(
                "String",
                "modvpn_BASE_URL",
                baseUrl
        ...
        release {
            ...
            buildConfigField("String", "modvpn_BASE_URL", "\"https://modvpn.app\"")
    ...
    flavorDimensions += listOf("modvpn")
