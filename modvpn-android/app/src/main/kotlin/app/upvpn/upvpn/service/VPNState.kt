...
import app.modvpn.modvpn.model.ServerReady
...
sealed class VPNOrchestratorState {
    ...
    data class Accepted(
        ...
        val accepted: app.modvpn.modvpn.model.Accepted,
    ...
    data class ServerCreated(
        val location: Location,
        val serverCreated: app.modvpn.modvpn.model.ServerCreated,
        val interFace: Interface
    ) : VPNOrchestratorState()

    data class ServerRunning(
        val location: Location,
        val serverRunning: app.modvpn.modvpn.model.ServerRunning,
        val interFace: Interface
    ) : VPNOrchestratorState()

    data class ServerReady(
        val location: Location,
        val serverReady: app.modvpn.modvpn.model.ServerReady,
        val config: Config
    ) : VPNOrchestratorState()
