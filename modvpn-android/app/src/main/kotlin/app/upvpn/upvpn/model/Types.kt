...
sealed class VpnSessionStatus {
    @Serializable
    @SerialName("accepted")
    data class Accepted(val content: app.modvpn.modvpn.model.Accepted) : VpnSessionStatus()

    @Serializable
    @SerialName("failed")
    data class Failed(val content: app.modvpn.modvpn.model.Failed) : VpnSessionStatus()

    @Serializable
    @SerialName("serverCreated")
    data class ServerCreated(val content: app.modvpn.modvpn.model.ServerCreated) : VpnSessionStatus()

    @Serializable
    @SerialName("serverRunning")
    data class ServerRunning(val content: app.modvpn.modvpn.model.ServerRunning) : VpnSessionStatus()

    @Serializable
    @SerialName("serverReady")
    data class ServerReady(val content: app.modvpn.modvpn.model.ServerReady) : VpnSessionStatus()

    @Serializable
    @SerialName("clientConnected")
    data class ClientConnected(val content: app.modvpn.modvpn.model.ClientConnected) :
        VpnSessionStatus()

    @Serializable
    @SerialName("ended")
    data class Ended(val content: app.modvpn.modvpn.model.Ended) : VpnSessionStatus()
}
